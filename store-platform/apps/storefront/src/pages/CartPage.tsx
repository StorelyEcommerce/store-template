    ...
    return (
      <div style={{ minHeight: '100vh', paddingTop: '5rem', display: 'flex', alignItems: 'center', justifyContent: 'center' }}>
        <div style={{ textAlign: 'center', maxWidth: '28rem', margin: '0 auto', padding: '0 1rem' }}>
          ...
          <p style={{ marginTop: '0.5rem', color: '#6b635a' }}>
    ...
    <div style={{ minHeight: '100vh', paddingTop: '5rem' }}>
      <div className="container" style={{ padding: '2rem 1rem' }}>
        ...
        <div style={{ marginBottom: '2rem' }}>
          ...
          <p style={{ marginTop: '0.25rem', color: '#6b635a' }}>
          ...
          <div>
            <div className="card" style={{ padding: '1.5rem' }}>
              ...
              <form onSubmit={handleCheckout} style={{ display: 'flex', flexDirection: 'column', gap: '1rem' }}>
                <div>
                  <label style={{ display: 'block', fontSize: '0.875rem', fontWeight: 500, color: '#4a443d', marginBottom: '0.5rem' }}>
                    Email *
                  </label>
                  <input
                    type="email"
                ...
                <div style={{ borderTop: '1px solid #e8e2d9', paddingTop: '1rem' }}>
                  ...
                  <div style={{ display: 'flex', flexDirection: 'column', gap: '0.75rem' }}>
                    <div>
                      <label style={{ display: 'block', fontSize: '0.75rem', fontWeight: 500, color: '#6b635a', marginBottom: '0.25rem' }}>
                        Full Name *
                      </label>
                      <input
                        type="text"
